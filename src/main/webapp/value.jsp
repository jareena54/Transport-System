	...
	<header>
		<nav>
			<ul class="navbar">
				...
				<li><a href="RecentlyInstalledTrucks">Recently
							...
							<tr>
								<td>
									...
									<form action="method" method="post">
										Enter status: <input type="text" name="status" required="required"> <br>
										Truck Model No<input type="text" name="truckmodelno" required="required">
										<br>
